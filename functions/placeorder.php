...
if (isset($_SESSION['auth']) == true) {
    if (isset($_POST['placeOrderBtn'])) {
        ...
        echo $totalPrice;
        $tracking_no = "dijanacode" . rand(1111, 9999) . substr($phone, 2);
        $insert_query = "INSERT INTO orders (tracking_no, user_id, name, email, phone, address, pincode, total_price, payment_mode, payment_id) VALUE ('$tracking_no', '$user_id', '$name', '$email', '$phone', '$address', '$pincode', '$totalPrice', '$payment_mode', '$payment_id')";
