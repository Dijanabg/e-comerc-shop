                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                            $order_query = "SELECT o.id as oid, o.tracking_no, o.user_id, oi.*,oi.qty as ordersqty, p.* FROM orders o, order_items oi, products p WHERE  oi.order_id=o.id AND p.id=oi.prod_id AND o.tracking_no='$tracking_no' ";
                                    ...
                                    <div class="mb-3">
                                        <form action="code.php" method="POST">
                                            <input type="hidden" class="tracking_no" value="<?= $data['tracking_no'] ?>">
